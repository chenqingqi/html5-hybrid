 ...
 * @param object:String 
 */
Element.prototype.find = function(object)
{
	...
	{
		return this.getElementsByTagName(object)[0];
	}
}
...
/**
 * 添加子节点
 * Element.prototype.appendChild(object)
 */
...
/**
 * 移除子节点
 * Element.prototype.removeChild(object)
 */
